  ...
  return (
    <div className="flex flex-col bg-[#EAE4D6]">
       ...
       <div className="md:w-[50%] relative h-[736px] w-full md:h-[900px]">
        ...
        <div className="w-[100%] md:w-[50%] h-full flex items-center justify-center">
          <div className="h-[800px] md:h-[800px] flex justify-center md:justify-around flex-col items-center w-[80%] md:w-[480px]">
            ...
            <div className="flex h-[201px] md:h-[123px] flex-col justify-end md:justify-end">
      ...
      <div className="w-full h-[120px] flex flex-col  justify-center bg-[#A28D77]">
        <p className={`${inter.className} w-[90%] pl-[60px] pt-[20px] font-normal text-[24px] leading-[120%] tracking-[0]`}>«La arquitectura debe hablar de su tiempo y lugar, pero aspirar a la atemporalidad».</p>
        <p className={`${inter.className} w-[90%]  pl-[60px] font-normal text-[24px] leading-[120%] tracking-[0]`}>
        — Frank Gehry  </p>
        </div>
    </div>
  );
